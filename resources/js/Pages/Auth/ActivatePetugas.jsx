...
export default function ActivatePetugas() {
  return (
    <GuestLayout>
      <Head title="Aktivasi Pembina" />
      <Card className="text-center py-10">
        <div className="mx-auto h-12 w-12 rounded-2xl bg-brand-secondary/10 flex items-center justify-center mb-4">
          <KeySquare className="h-5 w-5 text-brand-primary" />
        </div>
        ...
        <p className="text-sm text-brand-text/60 mt-2 max-w-sm mx-auto">
          Aktivasi akun pembina mutu dengan kode undangan sedang dalam pengembangan.
        </p>
